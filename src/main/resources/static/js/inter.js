...
//     d3.json("http://localhost:7476/rsks/hello/dataSource/node/id/" + id + "", function (error, json) { // 服务器加载知识图谱数据
//         if (error) {
...
//     var url = "http://localhost:7476/rsks/hello/dataSource/node/name/" + name + "";
...
//     var url = "http://localhost:7476/rsks/hello/dataSource/node/extend/" + id + "";
...
// 初始化图数据库配置信息
// function startNeo4j() {
//     var url = "http://localhost:7476/rsks/hello/neo4j";
